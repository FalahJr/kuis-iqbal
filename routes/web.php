...
Route::middleware(['authAdmin'])->prefix('admin')->group(function () {
    Route::get('/home', [DashboardController::class, 'indexDashboardAdmin'])->name('admin.home');

    Route::resource('/quiz', QuizController::class, ['as' => 'admin']);
    Route::get('/nama-quiz/{quizId}/soal', [QuizController::class, 'indexSoal'])->name('admin.quiz.indexSoal');
    Route::delete('/nama-quiz/{quizId}', [QuizController::class, 'destroyNamaQuiz'])->name('admin.quiz.destroyNamaQuiz');
    Route::get('/soal/create/{quizId}', [QuizController::class, 'createQuestion'])
        ->name('admin.soal.create');

    Route::post('/soal/store/{quizId}', [QuizController::class, 'storeQuestion'])->name('admin.soal.store');

    Route::get('/quiz/{quizId}/edit-question/{questionId}', [QuizController::class, 'editQuestion'])->name('admin.soal.edit');
    Route::post('/quiz/{quizId}/update-question/{questionId}', [QuizController::class, 'updateQuestion'])->name('admin.soal.update');

    Route::delete('/quiz/{quizId}/delete-question/{questionId}', [QuizController::class, 'deleteQuestion'])->name('admin.soal.destroy');
});
